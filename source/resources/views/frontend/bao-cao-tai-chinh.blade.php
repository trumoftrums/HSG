...
@section('content')
    ...
    <div class="doi-tac cong-bo-thong-tin">
        ...
        <div class="item-congbothongtin item02">
            <img class="thumb-congbothongtin" src="{{ url('assets/frontend/images/tai-chinh-02.png')}}"/>
            <div class="cover-list-item-congbo">
                <div class="item-congbothongtin-download">
                    <img src="{{ url('assets/frontend/images/icon-file-tai-chinh.png')}}"/>
                    <div class="cover-congbothongtin-right">
        ...
        <div class="item-congbothongtin item03">
            <img class="thumb-congbothongtin" src="{{ url('assets/frontend/images/tai-chinh-03.png')}}"/>
            <div class="cover-list-item-congbo">
                <div class="item-congbothongtin-download">
                    <img src="{{ url('assets/frontend/images/icon-file-tai-chinh.png')}}"/>
                    <div class="cover-congbothongtin-right">
        ...
        <div class="item-congbothongtin item04">
            <img class="thumb-congbothongtin" src="{{ url('assets/frontend/images/tai-chinh-04.png')}}"/>
            <div class="cover-list-item-congbo">
                <div class="item-congbothongtin-download">
                    <img src="{{ url('assets/frontend/images/icon-file-tai-chinh.png')}}"/>
                    <div class="cover-congbothongtin-right">
        ...
        <div class="item-congbothongtin item05">
            <img class="thumb-congbothongtin" src="{{ url('assets/frontend/images/tai-chinh-05.png')}}"/>
            <div class="cover-list-item-congbo">
                <div class="item-congbothongtin-download">
                    <img src="{{ url('assets/frontend/images/icon-file-tai-chinh.png')}}"/>
                    <div class="cover-congbothongtin-right">
